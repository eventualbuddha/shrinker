...
exports.RULES = {
  integer: new Rule(
    ...
    wrapGenerator.mark(function $callee(value, shrinker) {
      var positives, next, diff;
      ...
      return wrapGenerator(function $callee$($ctx0) {
        ...
        case 0:
          ...
          return -value;
        case 3:
          positives = shrinker.shrinks(-value);
        case 4:
  ...
  array: new Rule(
    ...
    wrapGenerator.mark(function $callee(value, shrinker) {
      var toRemove, offset, i, next, entry, smaller;
      ...
      return wrapGenerator(function $callee$($ctx2) {
        ...
        case 17:
          ...
          entry = value[i];
          smaller = shrinker.shrinks(entry);
        case 20:
  ...
  string: new Rule(
    ...
    wrapGenerator.mark(function $callee(value) {
      var toRemove, offset;
  ...
  date: new Rule(
    ...
    wrapGenerator.mark(function $callee(value, shrinker) {
      var millisecondsIterator, next;

      return wrapGenerator(function $callee$($ctx4) {
        while (1) switch ($ctx4.prev = $ctx4.next) {
        case 0:
          millisecondsIterator = shrinker.shrinks(value.valueOf());
        case 1:
          if ((next = millisecondsIterator.next()).done) {
            $ctx4.next = 6;
            break;
          }

          $ctx4.next = 4;
          return new Date(next.value);
        case 4:
          $ctx4.next = 1;
          break;
        case 6:
